<template>
  <div class="index">
    ...
    <div class="course_content">
      <div class="course_content_height">
      <span class="course_content_title">推荐机构</span>
      <span class="course_content_right">
          更多
  ...
  data() {
    return {
      ...
      items: [
        ...
        {
          id: 1,
          src: "../../static/footer_04.png",
          src1: "../../static/footer4.png",
          text: "咨询",
          isCurrent: false
        },
        {
          id: 2,
          src: "../../static/footer_05.png",
          src1: "../../static/footer5.png",
          text: "反馈",
          isCurrent: false
        },
        {
